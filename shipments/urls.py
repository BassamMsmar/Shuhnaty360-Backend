...
from .views import ShipmentListView, ShipmentDetails, ShipmentStatusView, ShipmentUpdate,ShipmentUpdateStatus, ShipmentCreateView, ShipmentOptionsView, ShipmentStatusOptionsView, ClientInvoiceNumberOptionsView
...
urlpatterns = [
    ...
    path('update/status/<int:pk>', ShipmentUpdateStatus.as_view(), name='Shipment-update_status'),
